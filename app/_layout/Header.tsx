    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 justify-between px-4 py-4 items-center shadow-sm bg-white">
        ...
        <input
          ...
          className="w-full sm:flex-1 pr-4 bg-gray-50 border pl-4 border-gray-200 rounded-lg py-2 text-sm sm:text-base"
        />
      ...
      {isSidebarOpen && (
        <>
          ...
          <div className="fixed top-0 left-0 h-full w-[200px] sm:w-[230px] bg-white shadow-xl p-4 z-50 animate-slide-right">
            ...
            <h2 className="text-lg sm:text-xl font-bold mb-6">Menu</h2>
        ...
        <>
          ...
          <div className='fixed top-1/2 left-1/2 w-[90%] sm:w-[400px] max-w-[400px] -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl p-4 sm:p-6 z-50'>
            ...
            <div className='flex justify-end gap-2 sm:gap-3 mt-4'>
              <button onClick={handleAdd} className="px-3 sm:px-4 py-1 sm:py-2 rounded-lg bg-gray-200 text-sm sm:text-base">Add</button>
              <button className='px-3 sm:px-4 py-1 sm:py-2 rounded-lg bg-gray-200 text-sm sm:text-base' onClick={() => setIsOpen(false)}>
                Close
              </button>
            </div>
          </div>
